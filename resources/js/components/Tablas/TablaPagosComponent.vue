...
<div class="col-sm">
                <div class="cold-md-4">
                    ...
                    <button @click="getPagos(1)" class="btn btn-outline-primary">Buscar</button>
                   <br>
                </div>
            ...
            <table class="table table-hover table-striped">
                ...
                <tbody>
                    <tr v-for="pago in pagos" :key="pago.id">
                        ...
                        <td><a :href="'clientes/' + pago.id">{{pago.clientes.nombre}}</a></td>
                        <td><a :href="'clientes/' + pago.id">{{pago.saldo}}</a></td>
                    </tr>
                </tbody>
            </table>
            <nav>
...
<script>
    export default {
        ...
        methods: {
            getPagos(page) {
                axios.get('/api/pago?page=' + page, {params: {name: this.name}}).then(resultado => {
