...
Vue.component('apertura-component', require('./components/Formularios/AperturaComponent.vue').default);
...
Vue.component('seleccion-proveedor-component', require('./components/SeleccionProveedorComponent.vue').default);
