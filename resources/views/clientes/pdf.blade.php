...
<div class="receipt-main">
  ...
  <div class="receipt-section">
    <p>El presente documento fue realizado en concepto de {{$concepto}} </p>
  </div>
  
  <div class="receipt-section">
    <p class="pull-right text-large">Encarnación, {{$fecha}}</p>
  </div>
